defmodule SymphonyElixir.Bootstrap.TrackerProviders.Linear do
  @moduledoc false
  ...
  @impl true
  def initial_status_expectations(%{human_review_polling?: human_review_polling?, human_review_state: human_review_state, rework_state: rework_state, merging_state: merging_state}) do
    []
